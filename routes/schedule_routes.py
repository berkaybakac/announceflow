...
@schedule_bp.route('/api/schedules/recurring/<int:schedule_id>/toggle', methods=['POST'])
@login_required
...
@schedule_bp.route('/api/schedules/recurring/<int:schedule_id>/delete', methods=['POST'])
@login_required
...
@schedule_bp.route('/api/schedules/recurring/delete-all-announcements', methods=['POST'])
@login_required
